...
package:
	...
	GOARCH=386   GOOS=windows               go build -o _out/ffsclient_win-386.exe         cmd/ffsclient/main.go  # Windows - 32 bit
	GOARCH=amd64 GOOS=windows               go build -o _out/ffsclient_win-amd64.exe       cmd/ffsclient/main.go  # Windows - 64 bit
	GOARCH=arm64 GOOS=windows               go build -o _out/ffsclient_win-arm64.exe       cmd/ffsclient/main.go  # Windows - ARM
